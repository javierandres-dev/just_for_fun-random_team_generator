"use strict";
const d = document, $form = d.getElementById('form'), $generateBy = $form.generateBy, $select = d.getElementById('select'), $teams = d.getElementById('teams');
let strParticipants = null, arrParticipants = [], $selected = null;
...
function eventListeners() {
    ...
    $form.addEventListener('reset', () => {
        var _a;
        (_a = $select === null || $select === void 0 ? void 0 : $select.parentElement) === null || _a === void 0 ? void 0 : _a.classList.add('v-hidden');
...
function handleSelect(option) {
    ...
    let limit = null, html = '<option value="">Please choose an option...</option>';
    if (option === 'byTeams') {
...
function generateTeams(amount, rule) {
    const indexs = [], participants = [], teams = [];
    let maxParticipants = null, arr = [];
    do {
